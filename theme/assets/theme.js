...
(function(){
  ...
  theme.buildProductGridItem = function(items, gridWidth, rowOf, imageSize) {
    ...
    items.forEach(product => {
      ...
      let save= (((product.compare_at_price - product.price)/product.compare_at_price)*100).toFixed(0);
      let priceMarkup = '';
      let vendorMarkup = '';
      ...
      // ${vendorMarkup}
      var markup = `
      <div class="recent-viewed grid__item grid-product ${gridWidth} aos-animate" data-aos="row-of-${rowOf}">
      <div class="grid-product__content">
        <a href="${product.url}" class="grid-product__link">
          ...
          <div class="grid-product__meta">
            ...
            <span class="grid-product__price--original">${theme.Currency.formatMoney(product.compare_at_price, theme.moneyFormat)}</span>
            ${theme.Currency.formatMoney(product.price, theme.moneyFormat)}
            <span class="grid-product__price--savings">
                Save ${save}%
              </span>
            </div>
            <button type="button" id="recent-Atc" onclick="addItemToCart(${product.variants[0].id},1)" class="btn btn--full atc-collection">Add To Cart </button> 
          </div>
